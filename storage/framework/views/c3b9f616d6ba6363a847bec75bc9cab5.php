...
<?php $__env->startSection('page-subtitle', 'Cập nhật thông tin đăng nhập và trạng thái tài khoản nhân viên'); ?>
...
<div class="staff-create-page staff-edit-page">
    ...
    <section class="staff-create-hero">
        <div>
            ...
            <h2>Chỉnh sửa <?php echo e($nhanvien->ho_ten); ?></h2>
            <p>Cập nhật họ tên, email đăng nhập và kiểm tra nhanh trạng thái hoạt động của tài khoản nhân viên trong hệ thống.</p>
        </div>

        <a href="<?php echo e(route('admin.nhanviens.index')); ?>" class="staff-create-soft-btn">
    ...
    <div class="staff-create-layout">
        <form action="<?php echo e(route('admin.nhanviens.update', $nhanvien)); ?>" method="POST" class="staff-create-panel">
            <?php echo csrf_field(); ?>
            ...
            <div class="staff-create-fields">
                <label class="staff-create-field">
                    <span>Họ và tên</span>
                    <div class="staff-create-control <?php $__errorArgs = ['ho_ten'];
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <input
                            type="text"
                            name="ho_ten"
                            value="<?php echo e(old('ho_ten', $nhanvien->ho_ten)); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <small class="staff-create-error"><?php echo e($message); ?></small>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <label class="staff-create-field">
                    ...
                    <div class="staff-create-control <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="staff-edit-status-card <?php echo e($isActive ? 'is-active' : 'is-locked'); ?>">
                <span>
                    <i class="fa-solid <?php echo e($isActive ? 'fa-circle-check' : 'fa-lock'); ?>"></i>
                </span>
                <div>
                    <strong><?php echo e($isActive ? 'Tài khoản đang hoạt động' : 'Tài khoản đang bị khóa'); ?></strong>
                    <p>
                        <?php echo e($isActive
        ...
        <aside class="staff-create-side">
            <section class="staff-create-preview">
                ...
                <div>
                    ...
                    <h3><?php echo e(old('ho_ten', $nhanvien->ho_ten)); ?></h3>
                    <p><?php echo e(old('email', $nhanvien->email)); ?></p>
                </div>
                <span class="staff-create-status <?php echo e($isActive ? '' : 'is-locked'); ?>">
                    <i class="fa-solid <?php echo e($isActive ? 'fa-circle-check' : 'fa-lock'); ?>"></i>
            ...
            <section class="staff-edit-meta">
                ...
                <div class="staff-edit-meta-list">
                    <div>
                        ...
                        <strong>#<?php echo e($nhanvien->id); ?></strong>
                    </div>
                    <div>
                        <span>Ngày tạo</span>
                        <strong><?php echo e($nhanvien->created_at?->format('d/m/Y H:i') ?? '-'); ?></strong>
                    </div>
                    <div>
                        <span>Cập nhật gần nhất</span>
                        <strong><?php echo e($nhanvien->updated_at?->format('d/m/Y H:i') ?? '-'); ?></strong>
                    </div>
                </div>
            </section>
            ...
            <section class="staff-edit-danger-zone">
                ...
                <form method="POST" action="<?php echo e(route('admin.nhanviens.toggle-status', $nhanvien)); ?>">
                    ...
                    <button
                        type="submit"
                        class="staff-edit-toggle-btn <?php echo e($isActive ? 'is-lock' : 'is-unlock'); ?>"
                        <?php if($isSelf): echo 'disabled'; endif; ?>
                    >
                        <i class="fa-solid <?php echo e($isActive ? 'fa-lock' : 'fa-lock-open'); ?>"></i>
                        <?php echo e($isActive ? 'Khóa tài khoản' : 'Mở khóa tài khoản'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\DuAnTotNghiep_CineHome\WD-11-Cinehome-cinema\resources\views/admin/nhanviens/edit.blade.php ENDPATH**/ ?>