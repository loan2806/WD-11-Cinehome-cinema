    ...
    <div class="min-h-screen bg-[#080808] pt-28 pb-12 text-white">
        ...
        <div class="mx-auto max-w-7xl px-6">
            ...
            <div
                ...
                <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        ...
                        <h1 class="mt-4 text-3xl font-black tracking-[0.08em] text-white sm:text-4xl">
                            Lịch chiếu phim <?php echo e($rap->ten_rap); ?>

                        </h1>
                        <p class="mt-3 max-w-2xl text-sm text-gray-400 sm:text-base">
                            <?php echo e($rap->dia_chi); ?>
                ...
                <form id="dateForm" action="<?php echo e(request()->url()); ?>" method="GET"
                    ...
                    <input type="hidden" name="ngay_chieu" id="selectedDateInput"
                        value="<?php echo e($selectedDate->toDateString()); ?>">
                        ...
                        <div id="dateList" class="flex flex-1 flex-nowrap gap-2 overflow-x-auto px-1 py-1 scrollbar-hide">
                            <?php $__currentLoopData = $dateOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dateOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <button type="button" data-date="<?php echo e($dateOption['date']); ?>"
                                    class="date-chip min-w-[76px] shrink-0 rounded-2xl border px-2 py-3 text-center transition duration-200 <?php echo e($dateOption['active'] ? 'date-chip-active border-yellow-400 bg-yellow-500/90 text-white shadow-lg shadow-yellow-500/20' : 'border-white/10 bg-white/5 text-gray-200 hover:border-yellow-400/40 hover:bg-white/10'); ?>">
                                    <div
                                        class="text-[11px] uppercase tracking-[0.25em] text-gray-400 <?php echo e($dateOption['active'] ? 'text-white/80' : ''); ?>">
                                        <?php echo e($dateOption['label']); ?>

                                    </div>
                                    <div class="mt-1 text-xl font-black leading-none">
                                        <?php echo e($dateCarbon->format('d')); ?>

                                    </div>
                                    <div
                                        class="mt-1 text-[10px] uppercase tracking-[0.2em] <?php echo e($dateOption['active'] ? 'text-white/80' : 'text-gray-500'); ?>">
                                        <?php echo e($dateCarbon->translatedFormat('D')); ?>
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-5 md:flex-row">
                            <div class="w-full shrink-0 md:w-[140px]">
                                <img src="<?php echo e($phim->poster ? asset('storage/movies/' . $phim->poster) : 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?q=80&w=600'); ?>"
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <?php $__currentLoopData = $showtimes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($suat->ghe_trong > 0): ?>
                                                <a href="<?php echo e(route('dat_ve.chon_ghe', ['movie' => $suat->phim->slug])); ?>"
                                                    ...
                                                    <div class="text-lg leading-none">
                                                        <?php echo e($suat->thoi_gian_chieu->format('H:i')); ?></div>
                                                    <div class="mt-1 text-[10px] font-semibold text-black/70">
                                                        <?php echo e($suat->ghe_trong); ?>/<?php echo e($suat->tong_ghe); ?> ghế
                                                    </div>
                                                </a>
                                            <?php else: ?>
                                                <div
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\WD-11-Cinehome-cinema\resources\views/user/dat_ve/chon_phim.blade.php ENDPATH**/ ?>