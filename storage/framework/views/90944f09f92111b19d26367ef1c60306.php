<?php $__env->startSection('title', 'Gioi thieu rap - CineHome'); ?>
...
<style>
    ...
    .cinema-hero {
        ...
        min-height: 88vh;
        align-items: end;
        background-image: linear-gradient(to bottom, rgba(0,0,0,.35), rgba(0,0,0,.78)), url('<?php echo e($cinemaImage); ?>');
            ...
            <div class="row">
                <div class="col-12 col-xl-9">
                    <span class="cinema-badge">
                        ...
                        Trải nghiệm điện ảnh cao cấp tại <?php echo e($cinemaCity); ?>
                    ...
                    <div class="d-flex flex-wrap gap-3 mt-4">
                        <a href="<?php echo e($showtimeUrl); ?>" class="cinema-btn-primary">
            ...
            <div class="row g-4 align-items-stretch">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="p-4 rounded-4" style="background: rgba(0,0,0,.25); border: 1px solid rgba(255,255,255,.06);">
                                    ...
                                    <div class="text-white fw-bold mt-2 lh-lg">
                                        ...
                                        <?php echo e($cinemaAddress); ?>, <?php echo e($cinemaCity); ?>
                ...
                <div class="col-12 col-lg-5">
                    <div class="cinema-card overflow-hidden">
                        <img src="<?php echo e($cinemaImage); ?>" alt="<?php echo e($cinemaName); ?>" style="width:100%; height:100%; min-height:420px; object-fit:cover;">
                    </div>
                </div>
            </div>
        </div>
                ...
                <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-6 col-lg-3">
                        <div class="cinema-card p-3 p-lg-4 text-center">
                            <div class="cinema-stat-icon mx-auto"><i class="<?php echo e($stat['icon']); ?>"></i></div>
                            <div class="cinema-stat-value"><?php echo e($stat['value']); ?></div>
                            <div class="text-white fw-bold"><?php echo e($stat['label']); ?></div>
                        </div>
                    </div>
                ...
                <?php $__currentLoopData = $reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-6 col-lg-4">
                        <div class="cinema-card p-3 text-center">
                            <div class="cinema-feature-icon mx-auto mb-2"><i class="<?php echo e($reason['icon']); ?>"></i></div>
                            <h3 class="h6 fw-bold text-white"><?php echo e($reason['title']); ?></h3>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
                ...
                <?php $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-12 col-md-6">
                        <div class="cinema-gallery-item cinema-card">
                            ...
                            <div class="cinema-gallery-caption"><?php echo e($item['title']); ?></div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-stretch">
                <div class="col-12 col-xl-7">
                    <div class="cinema-card p-3 p-md-4">
                        <iframe
                            ...
                            title="Ban do vi tri <?php echo e($cinemaName); ?>">
                        </iframe>
                    </div>
                </div>
                ...
                <div class="col-12 col-xl-5">
                    ...
                    <div class="d-flex flex-wrap gap-3 mt-4">
                        <a href="<?php echo e($mapDirectionUrl); ?>" target="_blank" rel="noopener noreferrer" class="cinema-btn-primary">
                            <i class="fa-solid fa-diamond-turn-right"></i>
                            Mở Google Maps
                        </a>
                        <a href="<?php echo e($showtimeUrl); ?>" class="cinema-btn-secondary">
                ...
                <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-12 col-lg-6">
                        <div class="cinema-card p-4">
                            <h3 class="h5 fw-bold text-white"><?php echo e($faq['question']); ?></h3>
                            <p class="cinema-text mt-3 mb-0"><?php echo e($faq['answer']); ?></p>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\WD-11-Cinehome-cinema\resources\views/user/cinemas/index.blade.php ENDPATH**/ ?>