...
<?php $__env->startSection('page-title', 'Quản lý danh mục đồ ăn'); ?>
...
<div class="admin-panel">
    ...
    <div class="panel-header flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <a href="<?php echo e(route('admin.foods.categories.create')); ?>"
    ...
    <form action="<?php echo e(route('admin.foods.categories.index')); ?>"
        method="GET"
        ...
        <a href="<?php echo e(route('admin.foods.categories.index')); ?>"
                        ...
                        <tr class="bg-[#0f0f0f] transition hover:bg-white/5">
                            ...
                            <td class="px-5 py-5">
                                ...
                                <div class="flex items-center justify-end gap-3 whitespace-nowrap">
                                    ...
                                    <a href="<?php echo e(route('admin.foods.categories.edit',$category)); ?>"
                                    ...
                                    <form action="<?php echo e(route('admin.foods.categories.destroy',$category)); ?>"
                                        method="POST">
    ...
    <?php echo $__env->make('components.admin-pagination',[
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\WD-11-Cinehome-cinema\resources\views/admin/foods/categories/index.blade.php ENDPATH**/ ?>