...
<?php $__env->startSection('content'); ?>
    ...
    <div class="space-y-6">
        ...
        <div class="space-y-4">
            ...
            <form method="GET" action="<?php echo e(route('admin.foods.index')); ?>"
                class="rounded-3xl border border-white/10 bg-[#0f0f0f] p-4 grid gap-3 lg:grid-cols-4">

                
                <input type="text" name="q" value="<?php echo e(request('q')); ?>" class="admin-input"
                ...
                <div class="rounded-3xl border border-white/10 bg-[#0f0f0f] p-5">
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="h-20 w-20 rounded-2xl overflow-hidden bg-white/5 flex items-center justify-center">
                            <?php if($food->image): ?>
                                <img src="<?php echo e(asset('storage/' . (str_starts_with($food->image, 'foods/') ? $food->image : 'foods/' . $food->image))); ?>"
                        ...
                        <div class="flex-1">
                            ...
                            <?php if($food->isCombo()): ?>
                                <p class="text-sm text-gray-400 mt-1">
                                    Thành phần:
                                    <b class="text-white">
                                        <?php echo e($food->comboItems->count()); ?>
                            ...
                            <?php else: ?>
                                <p class="text-sm text-gray-400 mt-1">
                                    Biến thể:
                                    <b class="text-white">
                                        <?php echo e($food->variants->count()); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\DuAnTotNghiep_CineHome\WD-11-Cinehome-cinema\resources\views/admin/foods/index.blade.php ENDPATH**/ ?>