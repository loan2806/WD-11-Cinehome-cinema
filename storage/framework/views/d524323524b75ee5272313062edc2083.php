            ...
            <aside class="rounded-2xl border border-white/10 bg-[#121212] p-5">
                <div class="flex flex-col items-start gap-4">
                    ...
                    <div class="w-full rounded-2xl border border-white/10 bg-zinc-900 p-4">
                        <h2 class="text-lg font-black text-yellow-500 mb-2"><?php echo e($suatChieu->phim->ten_phim); ?></h2>
                        <div class="text-sm text-gray-300">
                            <div><strong>Rạp:</strong> <?php echo e($suatChieu->rapChieuPhim->ten_rap); ?></div>
                            <div><strong>Phòng:</strong> <?php echo e($suatChieu->phongChieu->ten_phong ?? 'Phòng chiếu'); ?></div>
                            <div><strong>Suất chiếu:</strong> <?php echo e($suatChieu->thoi_gian_chieu->format('H:i d/m/Y')); ?></div>
                            <div><strong>Giá từ:</strong> <?php echo e(number_format($suatChieu->gia_ve, 0, ',', '.')); ?>đ</div>
                        </div>
                    </div>
                </div>
            </aside>
                                ...
                                <?php $__currentLoopData = $merged; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ghe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="seat-wrapper relative">
                                        ...
                                        <?php $__currentLoopData = $codes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <input type="checkbox" class="js-seat sr-only" value="<?php echo e(trim($seat)); ?>"
                                                <?php echo e($disabled ? 'disabled' : ''); ?>>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                        <button type="button"
                                            class="seat-button
                <?php echo e($isCouple ? 'seat-button--couple' : ''); ?>

                <?php echo e($isBooked ? 'booked' : ''); ?>

                <?php echo e($isMaintenance ? 'maintenance' : ''); ?>"
                                            style="--seat-color: <?php echo e($ghe['mau_sac']); ?>" data-seat="<?php echo e($seatLabel); ?>"
                                            data-seat-codes="<?php echo e($seatCodes); ?>" data-price="<?php echo e($ghe['gia']); ?>"
                                            data-type="<?php echo e($ghe['loai_ghe']); ?>" <?php if($disabled): echo 'disabled'; endif; ?>>

                                            <?php if($isCouple): ?>
                                                <div class="seat-couple-label">
                                                    <?php echo e(trim($codes[0])); ?> | <?php echo e(trim($codes[1])); ?>
                    ...
                    <div class="space-y-2 text-[13px] text-gray-300">
                        ...
                        <?php if($hasNormal): ?>
                            <div class="flex items-center justify-between">
                                ...
                                <b><?php echo e(number_format($normalPrice)); ?>đ</b>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($hasVip): ?>
                            <div class="flex items-center justify-between">
                                ...
                                <b><?php echo e(number_format($vipPrice)); ?>đ</b>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($hasDouble): ?>
                            <div class="flex items-center justify-between">
                                ...
                                <b><?php echo e(number_format($doublePrice)); ?>đ/cặp</b>
                            </div>
                        <?php endif; ?>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (btnFood) {
                ...
                btnFood.addEventListener("click", function(e) {
                    ...
                    window.location.href =
                        `<?php echo e(route('dat_ve.chon_do_an', ['suat_chieu_id' => $suatChieu->id])); ?>?ghe=${seats}`;
            ...
            window.addEventListener("beforeunload", function() {
                ...
                selectedSeats.forEach(function(seat) {
                    ...
                    navigator.sendBeacon(
                        `/dat-ve/seat-locks/${showtimeId}/${seat}?_method=DELETE&token=<?php echo e(csrf_token()); ?>`
                    );
        ...
        (function() {
            ...
            function updateCountdown() {
                ...
                if (remaining <= 0) {
                    ...
                    const showtimeId =
                        "<?php echo e($suatChieu->id ?? ($showtime->id ?? (request()->route('suat_chieu') ?? request()->route('suatChieu')))); ?>";
                    checked.forEach(function(seatId) {
                        try {
                            navigator.sendBeacon("<?php echo e(url('/dat-ve/seat-locks')); ?>/" + showtimeId + '/' +
                                seatId + '?_method=DELETE&token=<?php echo e(csrf_token()); ?>');
                        } catch (e) {}
                    });
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\WD-11-Cinehome-cinema\resources\views/user/dat_ve/chon_ghe.blade.php ENDPATH**/ ?>