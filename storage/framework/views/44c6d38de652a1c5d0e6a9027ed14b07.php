                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
                            ...
                            <div class="food-card bg-zinc-900 border border-white/10 rounded-2xl p-4 flex flex-col justify-between hover:border-yellow-400 transition" data-search-term="<?php echo e(mb_strtolower($food['name'])); ?>">
                                <div class="h-28 bg-black rounded-xl flex items-center justify-center overflow-hidden mb-3 relative border border-white/5">
                                    ...
                                    <?php if(($food['available'] ?? 0) <= 0): ?> <div class="absolute inset-0 bg-black/75 flex items-center justify-center">
                            ...
                            <p class="mt-2 text-center text-yellow-400 font-black text-sm">
                                <?php echo e(number_format((float) $food['price'], 0, ',', '.')); ?>đ
                            </p>

                            <p class="mb-3 mt-1 text-center text-[10px] text-gray-500">
                                Còn <?php echo e((int) ($food['available'] ?? 0)); ?> sản phẩm
                            </p>

                            <div class="flex gap-2">
                                <input type="number" min="1" max="<?php echo e(max((int) ($food['available'] ?? 0), 1)); ?>" value="1" class="qty w-12 bg-black border border-white/10 rounded-lg text-center text-xs font-bold focus:border-yellow-400 focus:outline-none" <?php if(($food['available'] ?? 0) <=0): echo 'disabled'; endif; ?>>

                                <button type="button" class="add-food flex-1 py-2 rounded-lg font-black text-xs transition
                <?php echo e(($food['available'] ?? 0) > 0
                    ? 'bg-yellow-400 text-black hover:bg-yellow-300'
                    : 'bg-zinc-700 text-gray-500 cursor-not-allowed'); ?>" data-cart-key="<?php echo e($food['cart_key']); ?>" data-type="<?php echo e($food['type']); ?>" data-id="<?php echo e($food['id']); ?>" data-food-id="<?php echo e($food['food_id']); ?>" data-variant-id="<?php echo e($food['variant_id'] ?? ''); ?>" data-name="<?php echo e($food['name']); ?>" data-price="<?php echo e($food['price']); ?>" data-available="<?php echo e($food['available'] ?? 0); ?>" <?php if(($food['available'] ?? 0) <=0): echo 'disabled'; endif; ?>>
                                    <?php echo e(($food['available'] ?? 0) > 0 ? 'THÊM' : 'HẾT HÀNG'); ?>
        ...
        <aside class="lg:sticky lg:top-24">
            <div class="bg-zinc-900 border border-white/10 rounded-3xl p-5 space-y-5 shadow-2xl">
                ...
                <form id="checkoutForm" action="<?php echo e(route('staff.ban-ve.checkout', $suatChieu->id)); ?>" method="POST">
                    ...
                    <input type="hidden" name="clear_cart_key" value="staff_food_cart_v2_<?php echo e(auth()->id()); ?>_<?php echo e($suatChieu->id); ?>">
...
<script>
    const cartKey = 'staff_food_cart_v2_<?php echo e(auth()->id()); ?>_<?php echo e($suatChieu->id); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\Cinema\WD-11-Cinehome-cinema\resources\views/staff/ban-ve/chon-do-an.blade.php ENDPATH**/ ?>