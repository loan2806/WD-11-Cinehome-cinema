<footer class="cine-footer">
    <div class="container-fluid px-5">
        ...
        <div class="text-center">
            © <?php echo e(date('Y')); ?> CineHome. All rights reserved.
        </div>
    </div>
</footer>
<?php /**PATH C:\laragon\www\WD-11-Cinehome-cinema - Copy\WD-11-Cinehome-cinema - Copy\resources\views/layouts/footer.blade.php ENDPATH**/ ?>