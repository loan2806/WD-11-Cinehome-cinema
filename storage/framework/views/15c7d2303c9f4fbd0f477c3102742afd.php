...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <label for="image"
                        ...
                        <?php if($food->image): ?>
                            <img id="current-image" src="<?php echo e(asset('storage/' . (str_starts_with($food->image, 'foods/') ? $food->image : 'foods/' . $food->image))); ?>"
                                ...
                                <div class="grid grid-cols-12 gap-3 items-start">
                                    ...
                                    <div class="col-span-8">
                                        <select name="combo_items[<?php echo e($index); ?>][variant_id]"
                                            class="admin-input <?php $__errorArgs = ["combo_items.$index.variant_id"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php $__currentLoopData = $variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($variant->id); ?>"
                                                    <?php echo e(old("combo_items.$index.variant_id", $item['variant_id']) == $variant->id ? 'selected' : ''); ?>>
                                                    <?php echo e($variant->doAn->name); ?> (<?php echo e($variant->value); ?>)
                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-span-3">
                                        <input type="number" min="1"
                                            name="combo_items[<?php echo e($index); ?>][quantity]"
                                            value="<?php echo e($item['quantity']); ?>" class="admin-input">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if(str_contains(strtolower(optional($food->category)->name), 'combo')): ?>
                <div class="mt-4">
                    ...
                    <input type="number" name="price" min="0" value="<?php echo e(old('price', $food->price)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\DuAnTotNghiep_CineHome\WD-11-Cinehome-cinema\resources\views/admin/foods/edit.blade.php ENDPATH**/ ?>