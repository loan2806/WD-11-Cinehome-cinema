        ...
        <div class="max-w-7xl mx-auto flex gap-10 relative">
            ...
            <section class="flex-1 space-y-10 pr-[360px]">
                ...
                <div>
                    ...
                    <p class="text-gray-500 mt-2 text-sm">
                        <?php echo e($suatChieu->phim->ten_phim); ?> · <?php echo e($suatChieu->rapChieuPhim->ten_rap); ?>
                ...
                <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="space-y-5">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="text-2xl">
                                <?php echo e($category['category'] === 'Đồ ăn' ? '🍿' : ($category['category'] === 'Đồ uống' ? '🥤' : '🎁')); ?>
                                ...
                                <?php if(!empty($food['is_combo'])): ?>
                                    <div
                                        ...
                                        <div
                                            ...
                                            <img src="<?php echo e(asset('storage/foods/' . $food['image'])); ?>"
           ...
           bg-black/30 px-2 py-1 shadow-inner backdrop-blur-md">
               ...
               transition hover:bg-yellow-300 active:scale-95 shadow-md"
                                            ...
                                            <button
                                                ...
                                                data-item-key="combo-<?php echo e($food['id']); ?>"
                                                data-item-name="<?php echo e($food['name']); ?>"
                                                data-item-price="<?php echo e($food['price'] ?? 0); ?>"
                                                data-item-image="<?php echo e($food['image']); ?>" data-item-type="combo"
                                                type="button">
                                                Thêm
                                            </button>
                                        </div>
           ...
           bg-black/30 px-2 py-1 shadow-inner backdrop-blur-md">
               ...
               transition hover:bg-yellow-300 active:scale-95 shadow-md"
                                                ...
                                                <button
                                                    class="btn-add-to-cart w-full rounded-xl bg-yellow-400 px-3 py-2 text-xs font-black uppercase tracking-[0.2em] text-black transition hover:bg-yellow-300"
                                                    data-item-key="variant-<?php echo e($variant['id']); ?>"
                                                    data-item-name="<?php echo e($food['name']); ?>"
                                                    data-item-price="<?php echo e($variant['price']); ?>"
                                                    data-item-image="<?php echo e($food['image']); ?>"
                                                    data-item-stock="<?php echo e($variant['stock']); ?>" data-item-type="variant"
                                                    type="button">
                                                    Thêm
                                                </button>
                                            </div>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\WD-11-Cinehome-cinema\resources\views/user/dat_ve/chon_do_an.blade.php ENDPATH**/ ?>