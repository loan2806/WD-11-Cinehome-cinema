                            ...
                            <div id="notifyBox" class="admin-notify-dropdown hidden">
                                <div class="admin-notify-head">
                                    ...
                                    <div>
                                        ...
                                        <small><?php echo e($notificationCount); ?> thông báo chưa đọc</small>
                                    </div>
                                </div>
                                ...
                                <div class="admin-notify-list">
                                    ...
                                    <article class="admin-notify-item <?php echo e($item->da_doc ? '' : 'is-unread'); ?>">
                                        ...
                                        <div class="admin-notify-content">
                                            <strong><?php echo e($item->tieu_de); ?></strong>
                                            <p><?php echo e(\Illuminate\Support\Str::limit($item->noi_dung, 86)); ?></p>
                                            <time><?php echo e($item->created_at->diffForHumans()); ?></time>
                                        </div>
                                    </article>
                        ...
                        <div class="relative" id="adminDropdownBox">
                            ...
                            <div id="adminDropdownMenu" class="absolute right-0 top-[125%] z-[9999] hidden w-60 overflow-hidden rounded-xl border border-[#d99a32]/30 bg-[#151515]/95 shadow-2xl backdrop-blur-md">
                                ...
                                <div class="p-1.5 border-b border-white/10">
                                    ...
                                    <a href="<?php echo e(route('admin.ve-xem-phims.index')); ?>" class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-semibold text-gray-300 transition hover:bg-[#d99a32] hover:text-[#2b1208] no-underline">
...
<?php /**PATH E:\laragon\www\Cinema\WD-11-Cinehome-cinema\resources\views/layouts/admin.blade.php ENDPATH**/ ?>