<?php $__env->startSection('title','Chọn ghế bán vé'); ?>
<?php $__env->startSection('page-title','Chọn ghế bán vé'); ?>
    ...
    <section class="booking-seat-hero">
        <div class="booking-flow-hero-copy">
            ...
            <p>
                ...
                Suất: <strong><?php echo e($suatChieu->thoi_gian_chieu->format('H:i')); ?></strong> -
                Phòng: <strong><?php echo e($suatChieu->phongChieu->ten_phong??'Không rõ'); ?></strong>
            </p>
            <div class="booking-seat-mini-stats">
                ...
                <div>
                    <strong><?php echo e($soldSeatCodes->count()); ?></strong>
                    <span>Đã bán</span>
                </div>
                <div>
    ...
    <div class="booking-seat-layout-admin">
            ...
            <div class="booking-seat-info-card">
                ...
                <dl>
                    <div>
                        ...
                        <dd><?php echo e($suatChieu->rapChieuPhim->ten_rap??'Không rõ'); ?></dd>
                    </div>
                    <div>
                        <dt><i class="fa-solid fa-door-open"></i> Phòng</dt>
                        <dd><?php echo e($suatChieu->phongChieu->ten_phong??'Không rõ'); ?></dd>
                    </div>
                    <div>
                        <dt><i class="fa-solid fa-calendar-days"></i> Ngày</dt>
                        <dd><?php echo e($weekdayLabels[$showDate->dayOfWeek]); ?>, <?php echo e($showDate->format('d/m/Y')); ?></dd>
                    </div>
                    <div>
                        <dt><i class="fa-solid fa-clock"></i> Giờ</dt>
                        <dd><?php echo e($showDate->format('H:i')); ?></dd>
                    </div>
                </dl>
            </div>

            <a href="<?php echo e(route('staff.ban-ve.index')); ?>" class="booking-seat-back-link">
            ...
            <div class="booking-theater">
                ...
                <div class="booking-seat-scroll">
                    <div class="booking-seat-grid">
                        <?php $__currentLoopData = $seatsByRow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hang=>$cacGhe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="seat-row">
                            <span class="row-label"><?php echo e($hang); ?></span>
                            <div class="seat-list">
                                <?php $__currentLoopData = $cacGhe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ghe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="seat-wrapper">
                                    <button type="button" class="seat-button <?php echo e($seatClass); ?> <?php echo e($isBooked?'booked':''); ?> <?php echo e($isMaintenance?'maintenance':''); ?>" data-seat="<?php echo e($seatCode); ?>" data-price="<?php echo e($seatPrice); ?>" <?php if($isBooked||$isMaintenance): ?> disabled <?php endif; ?>>
                                        <span><?php echo e($seatCode); ?></span>
                                    </button>
                                </div>
        ...
        <aside class="booking-seat-order-card">
            ...
            <div class="booking-seat-price-info">
                ...
                <?php $__currentLoopData = $seatTypePriceList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seatTypePrice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="price-info-row">
                        <span>
                            <i class="price-dot <?php echo e($seatTypePrice['dotClass']); ?>"></i>
                            <?php echo e($seatTypePrice['name']); ?>

                        </span>
                        <strong><?php echo e(number_format($seatTypePrice['price'], 0, ',', '.')); ?>đ</strong>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <form id="seatSaleForm" action="<?php echo e(route('staff.ban-ve.food',$suatChieu->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\DuAnTotNghiep_CineHome\WD-11-Cinehome-cinema\resources\views/staff/ban-ve/show.blade.php ENDPATH**/ ?>