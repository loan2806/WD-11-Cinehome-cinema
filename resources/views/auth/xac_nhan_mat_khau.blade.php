        ...
        <div class="w-full max-w-[500px] rounded-2xl border border-white/10 bg-[#151515]/95 p-10 shadow-2xl backdrop-blur-md">
            ...
            <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6 m-0">
                ...
                <div class="space-y-2">
                    ...
                    <input id="mat_khau" type="password" name="mat_khau" required class="block h-12 w-full rounded-xl border border-[#8a4a21] bg-[#2a2a2a]/60 px-4 text-base text-white outline-none focus:border-[#d99a32] focus:ring-1 focus:ring-[#d99a32]" />
