...
@php
    ...
    // Cùng công thức với DatVeController::chonGhe() — để trang bán vé tại quầy
    // có logic/giao diện sơ đồ ghế giống hệt trang đặt vé online.
    ...
    <section class="booking-seat-hero">
        <div class="booking-flow-hero-copy">
            <span class="booking-eyebrow">
                <i class="fa-solid fa-couch"></i> Nghiệp vụ quầy vé
            </span>
            <h1>Chọn ghế bán vé tại quầy</h1>
            <p>
                ...
                Ghế được giữ tạm 7 phút sau khi chọn.
            </p>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function validateSeatsAdjacentJS(seats) {
            ...
            for (const seat of seats) {
                ...
                if (match) {
                    parsedSeats.push({ row: match[1], num: parseInt(match[2], 10) });
                }
            }
        ...
        if (seatSaleForm) {
            seatSaleForm.addEventListener("submit", function (e) {
                ...
                if (!validateSeatsAdjacentJS(selectedSeats)) {
                    e.preventDefault();
                    showSeatErrorJS("Các ghế chọn phải liền kề nhau trong cùng một hàng!");
                    return;
                }
...
@push('styles')
<style>
@include('staff.ban-ve._seat-map-styles')
</style>
@endpush
