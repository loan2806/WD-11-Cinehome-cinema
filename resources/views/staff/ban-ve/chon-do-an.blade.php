                    ...
                    <div class="category-section" data-cat="{{ $catSlug }}">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
                            ...
                            <div class="food-card bg-zinc-900 border border-white/10 rounded-2xl p-4 flex flex-col justify-between hover:border-yellow-400 transition"
                                 data-search-term="{{ mb_strtolower($food['name']) }}">
                                
                                <div class="h-28 bg-black rounded-xl flex items-center justify-center overflow-hidden mb-3 relative border border-white/5">
                                    @if(!empty($food['image']))
                                        <img src="{{ asset('storage/'.$food['image']) }}" class="h-full object-contain hover:scale-110 transition duration-300">
                                    @else
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <button type="button" class="add-food flex-1 bg-yellow-400 text-black py-2 rounded-lg font-black text-xs hover:bg-yellow-300 transition" data-id="{{ $food['id'] }}" data-name="{{ $food['name'] }}" data-price="{{ $food['price'] }}">
                                        THÊM
                                    </button>
                                </div>
                            </div>
