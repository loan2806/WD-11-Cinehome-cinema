...
/* =========================================================
| NGƯỜI DÙNG CỤ THỂ
| Giữ toàn bộ người dùng đã chọn để edit có thể chọn nhiều.
========================================================= */

$oldSelectedUsers = old('nguoi_dung_cu_the', null);

if ($oldSelectedUsers !== null) {
    ...
    $oldSelectedUsersData = \App\Models\NguoiDung::whereIn(
        'id',
        $oldSelectedUsers
    )
        ->get(['id', 'ho_ten', 'email'])
...
} elseif ($selectedAudience === 'nguoi_dung_cu_the') {

    $oldSelectedUsersData =
...
<form
    action="{{ route('admin.thong-bao-push.update', ['thongBao' => $thongBaoPush->id]) }}"
    method="POST"
