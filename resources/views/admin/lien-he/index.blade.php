...
<style>
    ...
    .contact-action-btn {
        ...
        text-decoration: none;
        transition:
            transform 0.15s var(--cinema-ease),
            opacity 0.15s var(--cinema-ease),
            border-color 0.15s var(--cinema-ease),
            background 0.15s var(--cinema-ease);
    }
    ...
    .contact-action-btn.is-view:hover {
    ...
    .contact-action-btn.is-delete:hover {
...
$iconInbox = $svg('
<path d="M3 12h4.5l1.5 3h6l1.5-3H21M3 12v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6M3 12l2.25-6.75A1.5 1.5 0 0 1 6.68 4.25h10.64a1.5 1.5 0 0 1 1.43 1L21 12" />');
$iconClock = $svg('
...
$iconFilter = $svg('
<path d="M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m9 12h3.75M16.5 18a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 18H13.5M3.75 12h9.75m0 0a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0m9.75 0H21" />');
$iconReset = $svg('
<path d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99" />');
$iconUser = $svg('
...
$iconTrash = $svg('
<path d="m14.74 9-.346 9m-4.788 0L9.26 9M19.228 5.79c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.771 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />');
$iconInboxEmpty = $svg('
<path d="M3 12h4.5l1.5 3h6l1.5-3H21M3 12v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6M3 12l2.25-6.75A1.5 1.5 0 0 1 6.68 4.25h10.64a1.5 1.5 0 0 1 1.43 1L21 12" />');
$iconChevron = $svg('
                    ...
                    <tr>
                        ...
                        <td class="is-right">
                            <div class="contact-actions">
                                <a href="{{ route('admin.lien-he.show', $lienHe) }}"
                                    class="contact-action-btn is-view contact-receive-btn"
                                    title="Tiếp nhận">
                                ...
                                {{-- Xóa --}}
                                <form method="POST"
                                    action="{{ route('admin.lien-he.destroy', $lienHe) }}"
