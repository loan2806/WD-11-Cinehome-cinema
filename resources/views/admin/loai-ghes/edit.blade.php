...
@section('title', 'Sửa Loại Ghế - CineHome')
@section('page-title', 'Sửa Loại Ghế')
...
@section('content')
    ...
    <div class="admin-panel space-y-6">
        ...
        <div class="panel-header flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-white/5 pb-6">
            <div>
                ...
                <p class="text-sm text-gray-400 mt-1">
                    Cập nhật lại tên phân hạng, biểu phí phụ thu và màu sắc hiển thị
                </p>
            </div>
        ...
        <form action="{{ route('admin.loai-ghes.update', $loaiGhe) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="ten_loai" id="ten_loai" value="{{ old('ten_loai', $loaiGhe->ten_loai) }}"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" name="phu_thu" id="phu_thu" value="{{ old('phu_thu', $loaiGhe->phu_thu) }}" min="0" step="1000" required
                                class="w-full rounded-2xl border border-white/10 bg-[#1c1c1c] px-4 py-3 text-white outline-none focus:border-[#e50914] focus:ring-1 focus:ring-[#e50914] transition duration-200">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center gap-3">
                                <input type="color" name="mau_sac" id="mau_sac" value="{{ old('mau_sac', $loaiGhe->mau_sac ?? '#666666') }}"
                                ...
                                <input type="text" id="mau_sac_hex" value="{{ old('mau_sac', $loaiGhe->mau_sac ?? '#666666') }}"
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="mo_ta" id="mo_ta" rows="4" placeholder="Nhập một vài thông tin mô tả về loại ghế này..."
                            class="w-full rounded-2xl border border-white/10 bg-[#1c1c1c] px-4 py-3 text-white outline-none focus:border-[#e50914] focus:ring-1 focus:ring-[#e50914] transition duration-200">{{ old('mo_ta', $loaiGhe->mo_ta) }}</textarea>
                    </div>
