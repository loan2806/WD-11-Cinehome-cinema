...
@section('content')
    ...
    <div class="admin-panel">
        ...
        <form action="{{ route('admin.loai-ghes.update', $loaiGhe) }}" method="POST" class="mt-6 space-y-6">
            ...
            <div class="space-y-2">
                ...
                <textarea name="mo_ta" id="mo_ta" rows="4"
                    class="w-full rounded-2xl border border-white/10 bg-[#151515] px-4 py-3 text-white outline-none focus:border-[#d99a32]">{{ old('mo_ta', $loaiGhe->mo_ta) }}</textarea>
