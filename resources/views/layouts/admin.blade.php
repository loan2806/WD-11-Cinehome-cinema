    ...
    <div class="min-h-screen overflow-x-hidden bg-[#080808] text-white">
        ...
        <aside id="adminSidebar"
            ...
            <div class="mt-4 px-3 pb-8">
                ...
                <nav class="space-y-2">
                    <a href="{{ route('admin.movies.index') }}" class="admin-nav-link">
                    ...
                    <a href="{{ route('admin.showtimes.index') }}" class="admin-nav-link">
        ...
        {{-- MAIN --}}
        <main id="adminMain" class="min-h-screen overflow-x-hidden bg-[#080808]">
            {{-- TOPBAR --}}
            <header class="sticky top-0 z-50 border-b border-white/10 bg-[#101010]/95 backdrop-blur-xl">
                <div class="flex h-[76px] items-center justify-between gap-4 px-5">
                    ...
                    <div class="flex shrink-0 items-center gap-3">
                        ...
                        {{-- SEARCH --}}
                        <div
                            class="hidden h-11 w-[310px] items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 transition focus-within:border-[#d99a32]/70 focus-within:bg-white/10 xl:flex">
                        ...
                        <button type="button"
                            ...
                            <span
                                class="absolute right-3 top-3 h-2.5 w-2.5 rounded-full bg-red-500 ring-2 ring-[#101010]"></span>
                        </button>
                        ...
                        <div class="relative" id="adminDropdownBox">
                            <button id="adminDropdownBtn" type="button"
                                ...
                                <div
                                    class="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-[#8a4a21] to-[#d99a32]">
