            ...
            <div class="mt-4 px-3 pb-8">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('admin.hang-ghes.index') }}"
                        class="{{ request()->routeIs('admin.hang-ghes.*') ? 'admin-nav-link active' : 'admin-nav-link' }}">
                    ...
                    <a href="{{ route('admin.ghe-ngois.index') }}"
                        class="{{ request()->routeIs('admin.ghe-ngois.*') ? 'admin-nav-link active' : 'admin-nav-link' }}">
                ...
                <nav class="space-y-2">
                    <a href="{{ route('admin.ve-xem-phims.index') }}"
                        class="{{ request()->routeIs('admin.ve-xem-phims.*') ? 'admin-nav-link active' : 'admin-nav-link' }}">
