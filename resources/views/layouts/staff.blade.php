            ...
            <div class="mt-4 px-3 pb-8">
                ...
                <nav class="space-y-2">
                    ...
                    <a
                        ...
                        class="flex items-center gap-3 rounded-2xl px-4 py-3 font-bold transition {{ request()->routeIs('staff.tickets.scan') ? 'bg-gradient-to-r from-[#8a4a21] to-[#d99a32] text-white shadow-lg' : 'text-gray-300 hover:bg-white/10' }}"
                    >
                        <i class="fa-solid fa-qrcode w-5"></i>
                        Soát vé QR
                    </a>

                    <a href="#" class="flex items-center gap-3 rounded-2xl px-4 py-3 font-bold text-gray-300 transition hover:bg-white/10">
                ...
                <nav class="space-y-2">
                    <a href="{{ route('home') }}" class="flex items-center gap-3 rounded-2xl px-4 py-3 font-bold text-gray-300 transition hover:bg-white/10">
                ...
                <div class="flex h-[76px] items-center justify-between px-6">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="hidden lg:flex h-11 w-[300px] items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4">
                            ...
                            <input type="text" placeholder="Tìm kiếm..." class="h-full w-full bg-transparent text-sm text-white outline-none">
                        </div>
                        ...
                        <form action="{{ route('logout') }}" method="POST" class="m-0">
                            @csrf
                            <button class="rounded-2xl bg-red-500/20 px-4 py-2 font-bold text-red-400 transition hover:bg-red-500/30">
                                Đăng xuất
                            </button>
                        </form>
                    </div>
